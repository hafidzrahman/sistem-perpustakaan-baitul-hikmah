...
export const seeds = {
  buku: [
    ...
    {
      isbn: "979-017-281-8",
      judul: "Islam Keren : belajar setiap waktu dapat pahala beribu-ribu",
      genre: [Genre.KOMIK.toString()],
      penerbit: "Qultummemedia",
      penulis: ["Endar Novianto"],
      halaman: 126,
      ...
      posisi: "A2",
      linkGambar:
        "https://drive.google.com/file/d/1gF50RueMIA5amW0ditvfm9UOy6stTNDk/view?usp=drive_link",
    },
    {
      isbn: "979-28-8520-0",
    ...
    },
    {
      ...
      judul: "7 Hari Belajar Bahasa Jepang",
